        ...
        <div>
            ...
            <div className="flex flex-col lg:flex-row items-center justify-between p-4 sm:p-10">
                ...
                <div className="text-[16px] sm:text-[20px] md:text-[25px] lg:text-[30px] max-w-full sm:max-w-[90%] md:max-w-[80%] lg:max-w-[800px] mb-8 lg:mb-16 text-justify">
                    <p>
                        Welcome to Pinch of Yum a space where my love for cooking meets creativity. Here I share simple yet delicious recipes that anyone can make at home. Whether you're a beginner or a seasoned cook youll find something exciting to try. Let explore flavors together one dish at a time!
                    </p>
                </div>
            </div>
        </div>
